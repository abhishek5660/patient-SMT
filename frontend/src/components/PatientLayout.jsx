                                ...
                                {isNotificationsOpen && (
                                    <>
                                        ...
                                        <motion.div
                                            ...
                                            className="absolute right-0 mt-4 w-[calc(100vw-32px)] sm:w-[350px] bg-white rounded-3xl shadow-2xl p-4 overflow-hidden z-50 origin-top-right border border-gray-100"
                                        >
