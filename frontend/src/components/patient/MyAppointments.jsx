    ...
    return (
        <div className="space-y-8 pb-10">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                >
                    <h1 className="text-4xl font-black bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-600 tracking-tight">
                        My Appointments
                    </h1>
                            ...
                            >
                                <div className="flex justify-between items-start mb-6">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h3 className="font-black text-slate-900 group-hover:text-primary transition-colors">Dr. {appt.doctor?.name}</h3>
                                            <p className="text-xs text-primary font-bold uppercase tracking-wider">{appt.doctor?.specialization}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-4 mb-8">
                                    <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 border border-slate-100 group-hover:bg-white transition-colors">
                                        <div className="w-10 h-10 rounded-xl bg-white border border-slate-100 shadow-sm flex flex-col items-center justify-center text-primary leading-none">
                                            <span className="text-[10px] font-black uppercase mb-0.5 opacity-60">
                                                {new Date(appt.appointmentDate).toLocaleString('default', { month: 'short' })}
                                            </span>
                                            <span className="text-lg font-black">{new Date(appt.appointmentDate).getDate()}</span>
                                        </div>
                                        <div>
                                    ...
                                    {appt.status !== 'cancelled' && appt.status !== 'completed' ? (
                                        <>
                                            <button
                                                ...
                                                className="flex-1 py-3 rounded-xl border border-rose-100 text-rose-500 text-sm font-black hover:bg-rose-50 transition-colors"
                                            >
                                                Cancel
                                            </button>
                                        ...
                                        <button className="w-full py-3 rounded-xl bg-slate-50 text-slate-300 text-sm font-black cursor-not-allowed">
